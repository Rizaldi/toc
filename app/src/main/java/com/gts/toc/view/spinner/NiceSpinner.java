...
public class NiceSpinner extends TextView {
    ...
    public void onRestoreInstanceState(Parcelable savedState) {
        if (savedState instanceof Bundle) {
            ...
            if (mAdapter != null) {
                setText(mAdapter.getItemInDataset(mSelectedIndex).getItemName().toString());
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        int defaultPadding = resources.getDimensionPixelSize(R.dimen.spinner_padding);

        setGravity(Gravity.CENTER_VERTICAL | Gravity.LEFT);
        setPadding(resources.getDimensionPixelSize(R.dimen.spinner_padding), defaultPadding, defaultPadding,
                defaultPadding);
        setClickable(true);
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                setText(mAdapter.getItemInDataset(position).getItemName().toString());
                dismissDropDown();
            }
        });
    ...
    public void setSelectedIndex(int position) {
        if (mAdapter != null) {
            if (position >= 0 && position <= mAdapter.getCount()) {
                ...
                throw new IllegalArgumentException("Position must be lower than ShareAdapter count!");
            }
        }
    }
    ...
    public <T> void attachDataSource(@NonNull List<ObjSpinnerItem> dataset) {
    ...
    private void setAdapterInternal(@NonNull NiceSpinnerBaseAdapter adapter) {
        ...
        setText(adapter.getItemInDataset(mSelectedIndex).getItemName().toString());
    }
