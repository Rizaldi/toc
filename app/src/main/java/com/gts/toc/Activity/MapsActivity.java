...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng destLang     = new LatLng(-6.190772625040744,106.7983179911971);
        LatLng teknisiLang  = new LatLng(-6.367198300081161,106.83371342718601);
        getRoadMap(destLang, teknisiLang);
    }

    private void getRoadMap(LatLng destLang, LatLng teknisiLang){
        mMap.clear();
        MarkerOptions optionsDesc       = new MarkerOptions().position(destLang).title("Customer Position");
        ...
        mMap.moveCamera(CameraUpdateFactory.newLatLng(teknisiLang));
    ...
    public void onLocationChanged(Location location) {
        ...
        LatLng currentLang = new LatLng(location.getLatitude(), location.getLongitude());
        MarkerOptions markerOptions = new MarkerOptions();
        markerOptions.position(currentLang);
        markerOptions.title("Current Position");
//        markerOptions.icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_CYAN));
//        mMap.addMarker(markerOptions);
//        mMap.moveCamera(CameraUpdateFactory.newLatLng(currentLang));
//        mMap.animateCamera(CameraUpdateFactory.zoomTo(10));
